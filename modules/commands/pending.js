...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "tr.jpg")) request("https://i.imgur.com/dTIWgHA.gif").pipe(fs.createWriteStream(dirMaterial + "tr.png"));
}
    ...
    if (isNaN(body) && body.indexOf("c") === 0 || body.indexOf("cancel") === 0) {
        ...
        for (const singleIndex of index) {
            ...
            api.sendMessage({
                ...
                attachment: fs.createReadStream(__dirname + "/data/tr.png")
