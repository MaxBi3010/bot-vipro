...
const generateKey = () => {
    ...
    return `dgk_${randomString}_key_2025`.toLowerCase();
};
    ...
    try {
        ...
        for (const entry of data) {
            ...
            try {
                ...
                // Lỗi khi gửi thông báo đến nhóm
            }
        }
...
module.exports.handleEvent = async function (o) {
    ...
    const groupId = o.event.threadID;
    const keyMatch = message.match(/dgk_[0-9a-fA-F]{6}_key_2025/);
