...
const khanhchimto = (await axios.get(`https://i.imgur.com/AigEpxo.jpeg`, { responseType: "stream" })).data;
...
if(link.indexOf(".com/")!==-1) {
    ...
    if (participantIDs.includes(uidUser)) return api.sendMessage({body:`Thành viên đã có mặt trong nhóm`,attachment: khanhchimto }, threadID, messageID);
    ...
    else return api.sendMessage({body:`✅ Thêm thành viên vào nhóm thành công`,attachment: khanhchimto
		},  threadID, messageID);
    });
    }
  else { 
