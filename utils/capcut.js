...
async function post(url){
    ...
    const headers = {
      ...
      'sec-fetch-mode': 'cors',
      'sec-fetch-site': 'cross-site',
      'sign': '16c4d053dc4ae1ab619fe5cb6f734b93',
      'sign-ver': '1',
    ...
    try {
      const response = await axios.post(`https://feed-api.capcutapi.com/lv/v1/homepage/templates`, json, { headers });
      const medias = [];
