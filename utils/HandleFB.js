...
const Utils = {
    postWithToken: async (url, form, userAgent) => {
        return await got.post(url, {
            headers: {
                'authorization': `OAuth EAAAAUaZA8jlABOwC8OIQipuSsalLcDiLuVxZC3JarMZAaiGInMGMwqZBTyxwmkZAIZAJfxJ15wNyVp3YcLPjcnhFjbOcBWce4sxboZCVUGQSoHTZAjOV3gULx37kqHRZAyThGQvq3XOSdp8Jfum1bTcSUv6s4oEyedZC2Kl6K8m7MG0rleOOnNw68GlWJqslY4gjHEI8YGEAZDZD`,
